...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uwnqr9q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uwnqr9q.containers.anotherwebservice.com/
...
```
git clone git@github.com:jairof957/container-uwnqr9q.git
cd container-uwnqr9q
```
...
```
docker attach container-uwnqr9q
```
